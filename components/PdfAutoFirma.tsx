      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden">
        ...
        <div className="p-8 md:p-12 space-y-12">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              {isMobile ? (
                <div className="flex flex-wrap gap-4 pt-2">
                  <a 
                    ...
                    className="flex items-center gap-3 bg-slate-900 text-white px-6 py-4 rounded-2xl hover:bg-slate-800 transition-all shadow-lg"
                  >
                ...
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-3 bg-indigo-600 text-white px-8 py-5 rounded-2xl font-black text-lg hover:bg-indigo-700 hover:-translate-y-1 transition-all shadow-xl shadow-indigo-100"
                >
            ...
            <div className="md:w-72 shrink-0 bg-slate-50 border border-slate-200 rounded-3xl p-6 space-y-4">
              <h5 className="font-bold text-slate-900 text-sm uppercase tracking-widest">¿Por qué usarla?</h5>
          ...
          {/* Security Banner */}
          <div className="bg-emerald-600 rounded-3xl p-8 text-white flex flex-col md:flex-row items-center gap-6">
